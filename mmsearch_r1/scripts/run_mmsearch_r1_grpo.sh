...
python3 -m mmsearch_r1.trainer.multimodal.main_ppo \
    ...
    data.val_files=${WORKSPACE_DIR}/mmsearch_r1/data/sample1000_validation-00000-of-00007.parquet \
    ...
    trainer.experiment_name=revise_reward_klcoef1_kl_loss_coef1_search_penaltydot2 \
